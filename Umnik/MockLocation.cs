...
namespace Calc
{
    public static class Program
    {
         ...
         * @return
         */
        public static List<MockLocation> getLocations(double interval, double azimuth, MockLocation start, MockLocation end)
        {
