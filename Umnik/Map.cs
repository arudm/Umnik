...
namespace Umnik
{
    ...
    private async void StartFlight(object sender, EventArgs e)
    {
        await Task.Run(() =>
        {
            ...
            //start point
            double lat1 = Convert.ToDouble(txtLatY1.Text);
            double lng1 = Convert.ToDouble(LngX1.Text);
            // end point
            double lat2 = Convert.ToDouble(txtLatY2.Text);
            double lng2 = Convert.ToDouble(LngX2.Text);
